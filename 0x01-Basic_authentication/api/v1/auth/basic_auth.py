...
class BasicAuth(Auth):
    """ Class for Basic Authorization protocol methods
    """
    def extract_base64_authorization_header(self,
                                            authorization_header: str) -> str:
        """
        Return Base64 part of Authorization header for a Basic Authorization
        """
    ...
    def user_object_from_credentials(self, user_email: str,
        ...
        """
        Return a User object instance in based on email and password
        """
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        """
        Returns Current User instance based on a received request
        """
